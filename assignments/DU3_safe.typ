...
#show: project.with(
  ...
  authors: (
    "B0B01MA1",
    "Jakub Adamec",
    "Upravená verze pro účely výuky",
  ),
)
...
4. Spočtěte
$
integral (3x^2 - sqrt(x)) ln\3x dif x
$
\
\
\
...
=(5-2x)e^(-x) -2e^(-x)+c = 3e^(-x)-2x dot e^(-x) +c, x in RR
$
...
=(-3+2x) (cos\2x) /2 - (sin\2x) /2 + c = 1/2[ cos\2x dot (-3+2x) - sin\2x] +c, x in RR
$
